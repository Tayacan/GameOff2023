...
func _physics_process(_delta):
	var total_mass = obj_1.mass + obj_2.mass
	var combined_vel_1 = (obj_1_vel * obj_1.mass / total_mass) - (obj_2_vel * obj_2.mass / total_mass)
	var combined_vel_2 = (obj_2_vel * obj_2.mass / total_mass) - (obj_1_vel * obj_1.mass / total_mass)
	print_debug(
		"comb. vel 1: " + str(combined_vel_1) + "\n" +\
		"comb. vel 2: " + str(combined_vel_2)
	)
	
	if combined_vel_1.y >= 0:
		obj_1.y_vel = 0
		obj_2.y_vel = 0
	if combined_vel_2.y >= 0:
		obj_1.y_vel = 0
		obj_2.y_vel = 0
